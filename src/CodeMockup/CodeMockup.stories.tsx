...
Default.args = {
  children: <CodeMockup.Line>yarn add daisyui mintflow-react</CodeMockup.Line>,
}
...
LinePrefix.args = {
  children: (
    <CodeMockup.Line dataPrefix="$">
      yarn add daisyui mintflow-react
    </CodeMockup.Line>
  ),
}
...
MultiLine.args = {
  children: [
    <CodeMockup.Line>yarn add daisyui mintflow-react</CodeMockup.Line>,
